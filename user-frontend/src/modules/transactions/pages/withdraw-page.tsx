...
import { WithdrawsDataTable } from "../components/WithdrawsTable";
...
const WithdrawPage = () => {
  ...
  const fetchWithdraws = async () => {
    setLoading(true);
    try {
      const data = await transactionsApi.getWithdraws(page);
      setWithdraws(data.data.transactions);
